...
@Configuration
@ComponentScan(basePackages = {"org.example.dao", "org.example.metier", "org.example.config"})
public class Presentation2 {
    public static void main(String[] args) {
        ...
        // PropertyDrivenConfig créera un bean "org.example.dao" selon app.properties
